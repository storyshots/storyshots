...
├── src/
├── offline/
│   ├── @storyshots-core-0.0.19.tgz
│   ├── @storyshots-react-0.0.19.tgz
│   └── @storyshots-exec-preview-0.0.19.tgz
└── package.json
```
...
{
  "devDependencies": {
    "@storyshots/core": "file:offline/storyshots-core-0.0.19.tgz",
    "@storyshots/react": "file:offline/storyshots-react-0.0.19.tgz",
    "@storyshots/exec-preview": "file:offline/storyshots-exec-preview-0.0.19.tgz"
  }
}
```
