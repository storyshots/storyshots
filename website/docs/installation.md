...
`storyshots` легко интегрируется даже в уже написанные приложения благодаря своей [архитектуре](/website/docs/specification/scheme.md).
...
разделах [архитектура](/website/docs/specification/scheme.md) и [модули](/modules/).
...
├── src/
├── offline/
│   ├── @storyshots-core-0.0.16.tgz
│   ├── @storyshots-react-0.0.16.tgz
│   └── @storyshots-exec-preview-0.0.16.tgz
└── package.json
```
...
{
  "devDependencies": {
    "@storyshots/core": "file:offline/storyshots-core-0.0.16.tgz",
    "@storyshots/react": "file:offline/storyshots-react-0.0.16.tgz",
    "@storyshots/exec-preview": "file:offline/storyshots-exec-preview-0.0.16.tgz"
  }
}
```
...
После установки всё готово для описания [клиента preview](/website/docs/specification/scheme.md#ipreviewdisplay) и первых историй. Начнём с preview:
...
Далее необходимо описать [сервер preview](/website/docs/specification/scheme.md#ipreviewserver):
...
:::tip
Более подробно про `@storyshots/exec-preview` можно прочитать в [данном разделе](#todo).
:::
...
:::tip
Список всех доступных настроек доступен в [данном разделе](#todo).
:::
