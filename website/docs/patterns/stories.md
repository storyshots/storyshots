...
:::warning Внимание
Текст в блоках `describe` и `it` должен содержать только латиницу и/или спецсимволы.
:::
...
чтобы смягчить влияние данной проблемы, можно объявить приоритет с помощью [мета-аттрибутов](#todo):
