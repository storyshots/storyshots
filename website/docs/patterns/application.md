...
:::note
Чем тоньше слои взаимодействия с сервером ([внешняя среда](/specification/requirements/query) и [хранилище](/specification/requirements/command)) тем больше FE-разработчик сможет
...
- _[Внешняя среда](/specification/requirements/query)_ - подменяется программными средствами
