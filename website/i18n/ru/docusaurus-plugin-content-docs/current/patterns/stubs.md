...
# Написание заглушек {#writing-stubs}
...
## Заглушки фабрики {#factory-stubs}
...
### Меньше времени на инициализацию {#less-time-for-initialization}
...
### Упрощение изменений {#simplifying-changes}
...
[совместимых поведений](/patterns/externals#emulation-externals).
:::

## Модульные заглушки {#modular-stubs}

<MetricsTip improves={[Metric.Maintainability, Metric.Speed]} degrades={[Metric.RefactoringAllowance]} />

Одним из вариантов их упрощения является использование модульной структуры схожей с [модульной внешней средой](/patterns/externals#modular-externals). Если
...
разделе [модульная внешняя среда](/patterns/externals#modular-externals).
:::

:::warning Важно
Следует применять с осторожностью решения для генерации заглушек на
подобии [faker-js](https://github.com/faker-js/faker). Так как они зачастую производят [недереминированные](/specification/requirements/query#determinism) данные.
:::

## Неизбыточные заглушки {#non-redundant-stubs}
...
:::note
Данный пункт имеет тесную связь с [модульными заглушками](/patterns/stubs#modular-stubs). Однако, если последний описывал конкретный способ
...
## Релевантные заглушки {#relevant-stubs}
...
## Достаточные заглушки {#sufficient-stubs}
...
:::tip
Данный паттерн тесно связан с [модульными заглушками](/patterns/stubs#modular-stubs).
:::

## Упрощённые заглушки {#simplified-stubs}
