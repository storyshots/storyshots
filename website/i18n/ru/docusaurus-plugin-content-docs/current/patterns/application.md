...
### При разработке без API {#when-developing-without-api}
...
### При разработке с API {#when-developing-with-api}
...
### При рефакторинге {#when-refactoring}
...
## Разделение эталонов {#baseline-separation}
