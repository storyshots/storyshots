...
# Подмена поведений {#behavior-mocking}
...
## Подмена через инверсию {#mocking-through-inversion}
...
### Инверсия в React {#dependency-inversion-in-react}
...
:::tip
Тестовый код желательно отделять от реального окружения (см. [Дислокация тестов](/patterns/files#test-location)).
:::
...
## Подмена через сайд-эффекты {#mocking-through-side-effects}
...
### Monkey-patching в React {#monkey-patching-in-react}
