...
## Разделение историй {#story-splitting}
...
- С другой стороны, чем больше тест, тем сложнее контролировать уровень покрытия сценариев работы приложения, к тому же
  растёт риск смешивания ответственностей с которым борется пункт [декомпозиция историй](/patterns/stories#story-splitting).
...
## Приоритеты историй {#story-priorities}
...
## Универсальный render {#universal-render}
