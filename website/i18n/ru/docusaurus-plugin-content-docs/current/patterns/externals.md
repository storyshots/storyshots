...
## Тривиальные externals {#trivial-externals}
...
:::note
Вырезанная логика поднимается выше по стеку, попадая в [тестируемый слой](/specification/arch#aut).
:::
...
[Сервер preview](/specification/arch#ipreviewserver) должен собирать приложение идентичным целевой конфигурации
образом.
...
## Модульные externals {#modular-externals}
...
## Композиция externals {#composition-externals}
...
## Подмена externals {#mocking-externals}
...
## Эмуляция externals {#emulation-externals}
...
## Оптимизация arrange {#optimization-arrange}
...
:::tip
Данный паттерн особенно хорошо работает в связке с [модульной внешней средой](/patterns/externals#modular-externals).
:::
