...
:::note
Первый объект в списке `devices` становится [устройством по умолчанию](/ui/#run).
:::
...
Принимает [сервер preview](/specification/arch#ipreviewserver).
...
### Оптимальный алгоритм {#optimal-algorithm}
