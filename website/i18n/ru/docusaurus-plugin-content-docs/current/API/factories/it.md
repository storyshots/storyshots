...
:::tip
Поддерживаются также и другие [мета-аттрибуты](/modules/react#extensions) специфичные для
конкретного [клиента preview](/specification/arch#ipreviewclient).
:::
...
:::tip
`StoryAttributes` совместно с функциями над историями позволяет реализовывать большое количество [полезных поведений](/patterns/stories#story-priorities).
:::
