...
## Что такое storyshots {#what-is-storyshots}
...
### Взаимодействие с UI {#ui-interaction}
...
## Тест, в котором можно разрабатывать {#test-for-development}
...
## Верификация поведения, а не реализации {#behavior-verification-not-implementation}
...
## Стабильность на архитектурном уровне {#architectural-stability}

`storyshots` на [архитектурном уровне](/specification/arch) обеспечивает **закрытость тестов от деталей реализации**, что в свою очередь:
...
## Почему storyshots {#why-storyshots}
